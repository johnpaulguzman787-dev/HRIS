...
employee: {
    ...
    <main class="flex-1 overflow-y-auto min-h-screen w-full"
        ...
        <header class="bg-gradient-to-r from-blue-600 to-blue-700 text-white sticky top-0 z-10 shadow-lg mt-3 mx-3 rounded-2xl overflow-visible">
            <div class="px-5 py-4 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-xl font-bold text-white">Employee Profile</h1>
                </div>
        ...
        <div class="p-3 lg:p-6 space-y-4 lg:space-y-6">
            ...
            <div class="profile-card bg-white rounded-2xl overflow-hidden" style="box-shadow: 0 4px 24px rgba(0,0,0,0.06);">
                ...
                <div class="p-4 lg:p-6 pb-5 lg:pb-6">
                    <div class="flex items-end gap-4 -mt-8 mb-4">
                        <div class="avatar-pop flex-shrink-0 w-16 h-16 lg:w-20 lg:h-20 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center text-white text-xl lg:text-3xl font-bold shadow-xl" style="border: 4px solid white;"
                    ...
                    {{-- Mobile: 2-column grid for info --}}
                    <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-0">
                        <!-- Email -->
                        ...
                        <div class="info-row flex items-center gap-2 lg:gap-3 py-2 lg:py-4 px-2 lg:border-t border-t-gray-100">
                            ...
                            <div>
                                ...
                                <span class="inline-flex items-center gap-1 px-1.5 lg:px-2 py-0.5 rounded-full text-[9px] lg:text-xs font-bold bg-green-100 text-green-700">
            ...
            {{-- ── Job Information ── --}}
            <div class="section-card bg-white rounded-2xl p-4 lg:p-6" style="box-shadow: 0 4px 24px rgba(0,0,0,0.06);">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-3 gap-x-4 lg:gap-x-8 gap-y-3 lg:gap-y-6">
                    <div class="job-field group">
                        ...
                        <p class="text-[11px] lg:text-sm font-semibold text-gray-800" x-text="employee.department"></p>
                    </div>
                    <div class="job-field group">
                        <p class="text-[9px] lg:text-xs font-bold text-gray-400 uppercase tracking-widest mb-0.5 lg:mb-1.5">Job Title</p>
                        <p class="text-[11px] lg:text-sm font-semibold text-gray-800" x-text="employee.job_title"></p>
                    </div>
                    <div class="job-field group">
                        <p class="text-[9px] lg:text-xs font-bold text-gray-400 uppercase tracking-widest mb-0.5 lg:mb-1.5">Employment Type</p>
                        <p class="text-[11px] lg:text-sm font-semibold text-gray-800" x-text="employee.employment_type"></p>
                    </div>
                    <div class="job-field group">
                    ...
                    <div class="job-field group">
                        ...
                        <p class="text-[11px] lg:text-sm font-semibold text-gray-800" x-text="employee.contract_period"></p>
                    </div>
                    <div class="job-field group">
                        <p class="text-[9px] lg:text-xs font-bold text-gray-400 uppercase tracking-widest mb-0.5 lg:mb-1.5">Start Date</p>
                        <p class="text-[11px] lg:text-sm font-semibold text-gray-800" x-text="employee.start_date"></p>
                    </div>
                    <div class="job-field group">
                        <p class="text-[9px] lg:text-xs font-bold text-gray-400 uppercase tracking-widest mb-0.5 lg:mb-1.5">End Date</p>
                        <p class="text-[11px] lg:text-sm font-semibold text-gray-800" x-text="employee.end_date || '—'"></p>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-3">
                    <template x-for="(doc, index) in documents" :key="index">
                        <div class="doc-row flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-3 lg:p-4 rounded-xl border border-gray-100 hover:border-blue-200 hover:bg-blue-50/60 transition-all duration-300">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 lg:w-10 lg:h-10 rounded-xl bg-red-50 flex items-center justify-center flex-shrink-0">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button @click="window.location.href = doc.download_url" class="px-2 py-1 lg:px-4 lg:py-1.5 text-[10px] lg:text-xs font-semibold text-gray-600 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-700 hover:text-white transition-all duration-200">
                                    Download
                                </button>
                            </div>
                        </div>
        ...
        >
            <div class="flex items-center justify-between px-4 lg:px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-blue-600 to-blue-700">
                ...
                <button @click="closeDoc()"
                    class="w-7 h-7 lg:w-8 lg:h-8 rounded-lg bg-white/20 hover:bg-white/30 flex items-center justify-center text-white transition-all duration-200">
            ...
            <div class="flex items-center justify-end gap-2 lg:gap-3 px-4 lg:px-6 py-3 lg:py-4 border-t border-gray-100 bg-gray-50">
                ...
                <button @click="activeDoc && (window.location.href = activeDoc.download_url)" class="px-3 py-1.5 lg:px-5 lg:py-2 text-xs lg:text-sm font-semibold text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition-all duration-200 flex items-center gap-2">
                    <svg class="w-3 h-3 lg:w-4 lg:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<script>
    // Samp e view/download handlers for demo documents
