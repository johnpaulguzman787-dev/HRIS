...
<div x-data="{
        ...
        async handleClock() {
            ...
            if (!this.clockedIn) {
                ...
                const data = await res.json();
                if (res.ok) { this.clockedIn = true; this.clockInTime = data.clock_in; this.clockInTimestamp = Date.now(); }
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-5">
                ...
                <div class="space-y-4 lg:space-y-5">
                    ...
                    <div class="bg-white rounded-xl p-4 lg:p-6 card-anim" style="animation-delay:0.3s; border:1px solid #e5e7eb;">
                        ...
                        {{-- Department filter --}}
                        <div class="mb-3">
                            <select id="attendance-dept-filter" onchange="filterAttendanceSummary(this.value)" class="text-xs border border-gray-200 rounded-lg px-3 py-1.5 text-gray-600 bg-white focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400">
