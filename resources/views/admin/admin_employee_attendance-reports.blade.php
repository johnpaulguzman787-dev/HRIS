...
<aside
    ...
    <nav class="p-3 space-y-0.5 flex-1 overflow-y-auto">
        ...
        <a href="{{ route('admin.dashboard') }}"
           class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg {{ $currentRoute === 'admin.dashboard' ? 'text-white' : 'text-gray-600 hover:bg-gray-50' }}"
        ...
        <div>
            <button @click="employeesOpen = !employeesOpen"
                    class="nav-item w-full flex items-center justify-between px-3 py-2.5 rounded-lg {{ $isEmployeesSection ? 'text-white' : 'text-gray-600 hover:bg-gray-50' }}"
            ...
            <div x-show="employeesOpen && !sidebarCollapsed"
                ...
                <a href="{{ route('employees.directory') }}"
                   class="block px-3 py-2 text-sm rounded-lg {{ $currentRoute === 'employees.directory' ? 'text-blue-600 font-semibold bg-blue-50' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">
                    Employee Directory
                </a>
                <a href="{{ route('employees.profile') }}"
                   class="block px-3 py-2 text-sm rounded-lg {{ $currentRoute === 'employees.profile' ? 'text-blue-600 font-semibold bg-blue-50' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">
                    Employee Profile
                </a>
            </div>
        </div>
        ...
        <div>
            <button @click="attendanceOpen = !attendanceOpen"
                    class="nav-item w-full flex items-center justify-between px-3 py-2.5 rounded-lg {{ $isAttendanceSection ? 'text-blue-600 bg-blue-50' : 'text-gray-600 hover:bg-gray-50' }}">
                <div class="flex items-center space-x-3">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div x-show="attendanceOpen && !sidebarCollapsed"
                ...
                <a href="{{ route('admin.attendance.reports') }}"
                   class="flex items-center px-3 py-2 text-sm rounded-lg {{ $currentRoute === 'admin.attendance.reports' ? 'text-blue-600 font-semibold bg-blue-50' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">
                ...
                <a href="{{ route('admin.attendance.employee') }}"
                   class="block px-3 py-2 text-sm rounded-lg {{ $currentRoute === 'admin.attendance.employee' ? 'text-blue-600 font-semibold bg-blue-50' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">
                    Employee Attendance
                </a>
                <a href="#" class="block px-3 py-2 text-sm text-gray-500 hover:text-gray-800 hover:bg-gray-50 rounded-lg">Shift Scheduling</a>
        ...
        <div class="pt-3 mt-2 border-t border-gray-100">
            ...
            <a href="{{ route('settings.index') }}"
               class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg {{ $currentRoute === 'settings.index' ? 'text-white' : 'text-gray-600 hover:bg-gray-50' }}"
                ...
                <table class="monthly-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.attendance.employee', ['employee_id' => $i + 1, 'view' => 'monthly', 'month' => request('month', now()->format('Y-m'))]) }}"
                                   class="view-monthly-btn">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                    </svg>
