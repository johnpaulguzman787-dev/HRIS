{{-- resources/views/admin/admin_govpay.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Government Contributions – MEDISOURCE Admin</title>
    ...
    <style>
        * { font-family: 'DM Sans', sans-serif; box-sizing: border-box; }
        ...
        /* ── Mobile responsiveness (export + filter on one row) ── */
    ...
    <div class="flex-1 overflow-y-auto min-h-screen w-full transition-margin"
            ...
            <div class="px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs sm:text-sm text-blue-100 mt-1">SSS, PhilHealth, Pag-IBIG & Tax</p>
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-right pr-6">
                                            <a href="{{ route('admin.govpay.view', $row->payroll_period_id) }}" class="btn-view">View</a>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
        ...
        <div class="p-8">
            ...
            <div class="flex flex-wrap items-center gap-5 mb-6">
                <a href="{{ route('admin.govpay') }}" class="btn-back">
