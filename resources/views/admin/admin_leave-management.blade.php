        ...
        <div class="px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs sm:text-sm text-blue-100 mt-1">Manage and track employee leave</p>
                </div>
            </div>
    ...
    <div x-data="{ open: false, targetId: null, cancelling: false }"
        ...
        <div x-show="open"
            ...
            <div class="flex gap-3 justify-end">
                ...
                <button @click="cancelling = true; fetch('/admin/leave/'+targetId+'/cancel',{method:'POST',headers:{'X-CSRF-TOKEN':document.querySelector('meta[name=csrf-token]').content}}).then(r=>{cancelling=false;if(r.ok)location.reload();else alert('Failed to cancel.');open=false;})"
                        :disabled="cancelling"
