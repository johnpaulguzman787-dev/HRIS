...
<div x-data="{
    ...
    <div style="padding:24px 32px;">
        ...
        {{-- Tab Nav --}}
        <div class="tab-nav">
            <a href="{{ route('admin.leave.management', ['tab' => 'my-leave']) }}"      class="tab-btn {{ $activeTab === 'my-leave'      ? 'active' : '' }}">My Leave</a>
            <a href="{{ route('admin.leave.management', ['tab' => 'leave-calendar']) }}" class="tab-btn {{ $activeTab === 'leave-calendar' ? 'active' : '' }}">Leave Calendar</a>
...
<select class="filter-select" onchange="window.location.href='{{ route('admin.leave.management') }}?tab=my-leave&type='+this.value+'&status={{ request('status') }}'">
