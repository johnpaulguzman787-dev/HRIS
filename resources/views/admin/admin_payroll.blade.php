                ...
                <div class="period-title-wrapper flex items-center justify-between mb-6">
                    ...
                    <div class="flex items-center gap-2">
                        <template x-if="viewPeriod.status === 'Pending'">
                            <button class="btn-primary" @click="adminSubmitPeriod()">Submit for Approval</button>
                        </template>
                        <template x-if="viewPeriod.status === 'Submitted'">
                            <button class="btn-primary" @click="showReleaseConfirm=true">Release Payroll</button>
                        </template>
    ...
    <div x-show="showCreatePeriod" x-cloak class="fixed inset-0 z-50 flex items-center justify-center modal-overlay" @click.self="showCreatePeriod=false">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6 sm:p-8"
            ...
            <form method="POST" action="{{ route('admin.payroll.period.store') }}">
                ...
                {{-- Buttons remain on one row (unchanged) --}}
                <div class="flex justify-end gap-3 mt-6">
