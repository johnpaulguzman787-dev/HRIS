    ...
    <nav class="p-4 space-y-1">
        ...
        <a href="{{ route('admin.dashboard') }}" 
            class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-300 hover:bg-blue-50 group
                {{ $currentRoute === 'admin.dashboard' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:text-blue-600' }}"
        >
            <svg class="w-5 h-5 flex-shrink-0 {{ $currentRoute === 'admin.dashboard' ? 'text-blue-600' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="relative">
            <button 
                ...
                class="w-full flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-300 group
                    {{ $isEmployeesSection ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50' }}"
            >
            ...
            <div x-show="employeesOpen && !sidebarCollapsed" 
                ...
                <a href="{{ route('employees.directory') }}" 
                   class="block px-4 py-2 text-sm rounded-lg transition-all duration-200 hover:translate-x-1
                       {{ $currentRoute === 'employees.directory' ? 'bg-blue-100 text-blue-700 font-semibold' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600' }}">
                    Employee Directory
                </a>
                <a href="{{ route('employees.profile') }}" 
                   class="block px-4 py-2 text-sm rounded-lg transition-all duration-200 hover:translate-x-1
                       {{ $currentRoute === 'employees.profile' ? 'bg-blue-100 text-blue-700 font-semibold' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600' }}">
                    Employee Profile
                </a>
        ...
        <div class="pt-4 mt-4 border-t border-gray-100 space-y-1">
            <a href="{{ route('settings.index') }}" 
                class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-300 group
                    {{ $currentRoute === 'settings.index' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600' }}"
            >
                <svg class="w-5 h-5 flex-shrink-0 transition-all duration-300 group-hover:rotate-90 {{ $currentRoute === 'settings.index' ? 'text-blue-600' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
