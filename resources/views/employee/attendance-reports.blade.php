...
<head>
    ...
    <title>Attendance Reports – MEDISOURCE</title>
...
<aside
    ...
    <div class="px-5 py-5 border-b border-gray-100">
        <div class="flex items-center space-x-3" :class="sidebarCollapsed ? 'justify-center' : ''">
            <div class="w-9 h-9 border-2 border-gray-800 flex items-center justify-center flex-shrink-0 rounded-lg">
            ...
            <h1 x-show="!sidebarCollapsed"
                ...
                class="font-black text-gray-900 text-base tracking-widest whitespace-nowrap">MEDISOURCE</h1>
        </div>
    </div>
    ...
    <div class="px-4 py-4 border-b border-gray-100" :class="sidebarCollapsed ? 'flex justify-center' : 'flex items-center space-x-3'">
        ...
        <div x-show="!sidebarCollapsed"
            ...
            <p class="text-xs mt-0.5 font-semibold truncate" style="color:#3b82f6;">{{ $sidebarRole }}</p>
        </div>
    </div>
    ...
    <nav class="p-3 space-y-0.5 flex-1 overflow-y-auto">
        ...
        <a href="{{ route('employee.dashboard') }}"
           class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-xl
        ...
        <div>
            <button @click="attendanceOpen = !attendanceOpen"
                class="nav-item w-full flex items-center justify-between px-3 py-2.5 rounded-xl
            ...
            <div x-show="attendanceOpen && !sidebarCollapsed"
                ...
                <a href="#" class="submenu-item block px-3 py-2 text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-50 rounded-lg">Shift Scheduling</a>
                <a href="#" class="submenu-item block px-3 py-2 text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-50 rounded-lg">Leave Management</a>
            </div>
        </div>

        <div>
            <button @click="payrollOpen = !payrollOpen"
                class="nav-item w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-gray-600 hover:bg-gray-50">
                <div class="flex items-center space-x-3">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div x-show="payrollOpen && !sidebarCollapsed"
                 ...
                 x-transition:leave-end="opacity-0"
                 class="ml-8 mt-0.5 space-y-0.5">
                <a href="#" class="submenu-item block px-3 py-2 text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-50 rounded-lg">Payroll</a>
                <a href="#" class="submenu-item block px-3 py-2 text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-50 rounded-lg">Payslips</a>
                <a href="#" class="submenu-item block px-3 py-2 text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-50 rounded-lg">Govt. Contributions</a>
            </div>
        </div>
        ...
        <div>
            ...
            <div x-show="requestsOpen && !sidebarCollapsed"
                 ...
                 x-transition:leave-end="opacity-0"
                 class="ml-8 mt-0.5 space-y-0.5">
                <a href="#" class="submenu-item block px-3 py-2 text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-50 rounded-lg">Pending Requests</a>
                <a href="#" class="submenu-item block px-3 py-2 text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-50 rounded-lg">Approved Logs</a>
            </div>
        </div>

        <div class="pt-3 mt-2 border-t border-gray-100">
            <p x-show="!sidebarCollapsed" class="text-xs text-gray-400 font-semibold px-3 py-2 uppercase tracking-widest">Others</p>
            <a href="#" class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-xl text-gray-600 hover:bg-gray-50 group">
            ...
            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('employee-logout-form').submit();"
               class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-xl text-gray-600 hover:bg-red-50 hover:text-red-500">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="p-6 space-y-5">
        ...
        <div class="flex gap-5 items-stretch">
            ...
            <div class="anim-up bg-white rounded-2xl p-6 flex-shrink-0 flex flex-col"
                ...
                {{-- Big Clock --}}
                <div class="mb-1">
                    <p class="font-black text-gray-900 tabular-nums leading-none"
                ...
                <div class="mb-3">
                    ...
                    <p class="text-xs text-center font-medium" x-show="clockedIn && !clockedOut" style="color:#3b82f6;">
                        <span class="mr-1">⏱</span>
                        <span x-text="elapsedDisplay"></span>
                    </p>
            ...
            <div class="flex-1 grid grid-cols-2 grid-rows-3 gap-4">
                ...
                <div class="stat-card p-5 flex flex-col justify-between" style="background:#c8f0d8; animation-delay:0.08s;">
                    ...
                    <div>
                        <p class="font-black leading-none mt-2" style="font-size:3.2rem; color:#2563eb;">26</p>
                        <p class="text-xs font-semibold mt-2 uppercase tracking-wider" style="color:#15803d;">February 2026</p>
                    </div>
                </div>
                ...
                <div class="stat-card p-5 flex flex-col justify-between" style="background:#fde8c8; animation-delay:0.11s;">
                    ...
                    <div>
                        <p class="font-black leading-none mt-2" style="font-size:3.2rem; color:#1f2937;">2</p>
                        <p class="text-xs font-semibold mt-2 uppercase tracking-wider" style="color:#b45309;">February 2026</p>
                    </div>
                </div>
                ...
                <div class="stat-card p-5 flex flex-col justify-between" style="background:#fbc8c8; animation-delay:0.14s;">
                    ...
                    <div>
                        <p class="font-black leading-none mt-2" style="font-size:3.2rem; color:#1f2937;">0</p>
                        <p class="text-xs font-semibold mt-2 uppercase tracking-wider" style="color:#dc2626;">February 2026</p>
                    </div>
                </div>
                ...
                <div class="stat-card p-5 flex flex-col justify-between" style="background:#f9c8e8; animation-delay:0.17s;">
                    ...
                    <div>
                        <p class="font-black leading-none mt-2" style="font-size:3.2rem; color:#1f2937;">2</p>
                        <p class="text-xs font-semibold mt-2 uppercase tracking-wider" style="color:#be185d;">February 2026</p>
                    </div>
                </div>
                ...
                <div class="stat-card p-5 flex flex-col justify-between" style="background:#c8dafa; animation-delay:0.20s;">
                    ...
                    <div>
                        <p class="font-black leading-none mt-2" style="font-size:3.2rem; color:#1f2937;">2</p>
                        <p class="text-xs font-semibold mt-2 uppercase tracking-wider" style="color:#1d4ed8;">February 2026</p>
                    </div>
                </div>
...
function attendancePage() {
    return {
        ...
        tick() {
            ...
            this.liveTime = `${h}:${m}:${s}`;
            this.liveDate = n.toLocaleDateString('en-US', {
        ...
        rows: [
            ...
            { date:'February 24, 2026', setup:'WFH', shift:'Day Shift', schedule:'7:00 AM – 4:00 PM', clockIn:'7:00 AM', clockOut:'4:00 PM', overtime:'00h 00m', status:'Present' },
            ...
            { date:'February 22, 2026', setup:'WFH', shift:'Day Shift', schedule:'7:00 AM – 4:00 PM', clockIn:'7:00 AM', clockOut:'4:00 PM', overtime:'00h 23m', status:'Late'    },
            ...
            { date:'February 20, 2026', setup:'WFH', shift:'Day Shift', schedule:'7:00 AM – 4:00 PM', clockIn:'7:00 AM', clockOut:'4:00 PM', overtime:'00h 23m', status:'Present' },
        ...
        statusStyle(s) {
            return {
                'Present':  'background:rgba(34,197,94,0.12);  color:#16a34a;',
                'Late':     'background:rgba(245,158,11,0.12); color:#d97706;',
                'Absent':   'background:rgba(239,68,68,0.12);  color:#dc2626;',
                'On Leave': 'background:rgba(99,102,241,0.12); color:#4f46e5;',
