...
<div x-data="{
    ...
    <aside
        ...
        <div class="px-4 py-4 border-b border-gray-100 profile-card" :class="sidebarCollapsed ? 'flex justify-center' : 'flex items-center space-x-3'">
            ...
            <div x-show="!sidebarCollapsed"
                ...
                <p class="font-semibold text-gray-800 text-sm leading-tight">Juan Dela Cruz</p>
                <p class="text-xs mt-0.5" style="color:#3b82f6; font-weight:600;">Senior Programmer</p>
            </div>
        </div>
        ...
        <nav class="p-3 space-y-0.5 flex-1 overflow-y-auto">
            ...
            <!-- Employee Profile (single link, no dropdown) -->
            <a href="#"
                class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg text-gray-600 hover:bg-gray-50">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <main class="flex-1 overflow-y-auto min-h-screen"
        ...
        <div class="p-6">
            ...
            <!-- ROW 1: Stat Cards — employee personal stats -->
            <div class="grid grid-cols-3 gap-5 mb-5">
                ...
                <div class="stat-card bg-white rounded-xl p-6 card-anim" style="animation-delay:0.15s; border:1px solid #e5e7eb;">
                    ...
                    <p class="text-5xl font-bold" style="color:#3b82f6;">12</p>
                    <p class="text-xs text-gray-400 mt-3 uppercase tracking-wider font-medium">{{ strtoupper(date('F Y')) }}</p>
                ...
                <div class="stat-card bg-white rounded-xl p-6 card-anim" style="animation-delay:0.25s; border:1px solid #e5e7eb;">
                    ...
                    <p class="text-5xl font-bold" style="color:#3b82f6;">3</p>
                    <div class="stat-bar mt-2" style="margin-top: 2.35rem;"><div class="stat-bar-fill" style="width:30%; background:#22c55e;"></div></div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-5">
                ...
                <!-- COL 1: Shift Schedule + Quick Actions -->
                <div class="space-y-5">
                    ...
                    <div class="bg-white rounded-xl p-6 card-anim" style="animation-delay:0.3s; border:1px solid #e5e7eb;">
                        ...
                        <p class="text-xs text-gray-400 mt-1 mb-4">Today - {{ date('F d, Y') }}</p>

                        <!-- Shift Visual Box -->
                        <div class="rounded-xl p-4 mb-4" style="background:#f8faff; border:1px solid #dbeafe;">
                            <p class="text-sm font-bold text-gray-700 mb-3">Day Shift WFH</p>
                            <div class="grid grid-cols-3 gap-2 mb-4">
                                <div class="shift-time-box rounded-lg p-2.5 text-center" style="background:#fff; border:1px solid #e5e7eb;">
                                    <p class="text-sm font-bold text-gray-800">7:00 AM</p>
                                    <p class="text-xs text-gray-400 uppercase font-semibold mt-0.5">Start</p>
                                </div>
                                <div class="shift-time-box rounded-lg p-2.5 text-center" style="background:#fff; border:1px solid #e5e7eb;">
                                    <p class="text-xs font-bold text-gray-800">12:00 PM - 1:00 PM</p>
                                    <p class="text-xs text-gray-400 uppercase font-semibold mt-0.5">Break</p>
                                </div>
                                <div class="shift-time-box rounded-lg p-2.5 text-center" style="background:#fff; border:1px solid #e5e7eb;">
                                    <p class="text-sm font-bold text-gray-800">4:00 PM</p>
                                    <p class="text-xs text-gray-400 uppercase font-semibold mt-0.5">End</p>
                                </div>
                            </div>
                            ...
                            <div class="h-2 rounded-full overflow-hidden" style="background:#dbeafe;">
                                <div class="shift-progress-fill h-full rounded-full" style="background: linear-gradient(90deg, #3b82f6, #60a5fa);"></div>
                            </div>
                        </div>
                    </div>
...
/* Shift progress bar */
.shift-progress-fill { width: 0; animation: shiftFill 2s cubic-bezier(0.22,1,0.36,1) 0.8s forwards; }
@keyframes shiftFill { to { width: 0%; } }

/* Shift time boxes */
.shift-time-box { transition: transform 0.2s cubic-bezier(0.34,1.56,0.64,1), box-shadow 0.2s ease; }
.shift-time-box:hover { transform: translateY(-2px); box-shadow: 0 4px 12px rgba(59,130,246,0.12); }
