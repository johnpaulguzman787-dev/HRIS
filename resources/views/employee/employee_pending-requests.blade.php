...
<aside
    ...
    <nav class="p-3 space-y-0.5 flex-1 overflow-y-auto">
        ...
        <!-- Dashboard -->
        <a href="{{ route('employee.dashboard') }}" class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg group {{ $currentRoute === 'employee.dashboard' ? 'text-white' : 'text-gray-600 hover:bg-gray-50' }}" style="{{ $currentRoute === 'employee.dashboard' ? 'background:#3b82f6;' : '' }}">
        ...
        <div class="pt-3 mt-2 border-t border-gray-100">
            ...
            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('employee-logout-form').submit();" class="nav-item logout-btn flex items-center space-x-3 px-3 py-2.5 rounded-lg text-gray-600 hover:bg-red-50 hover:text-red-500">
    ...
    <!-- Collapse Button -->
    <button @click="sidebarCollapsed = !sidebarCollapsed" class="m-3 w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center text-gray-500 hover:bg-gray-200 self-end collapse-btn">
...
<div x-data="{
    ...
    <div style="padding:24px 32px;">
        ...
        <div class="rcard">
            ...
            <div class="action-row">
                <button class="btn-approve" style="background:#dbeafe;color:#1d4ed8;" @click="showFileReq=true">
                    <svg style="width:14px;height:14px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg> Edit
                </button>
                <button class="btn-reject" style="background:#fee2e2;color:#dc2626;" @click="selId=2;selName='Juan Dela Cruz';showReject=true">
                    <svg style="width:14px;height:14px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg> Cancel
                </button>
            </div>
        </div>
        @empty
    ...
    <div x-show="showApprove" class="modal-overlay" x-cloak @click.self="showApprove=false">
        <div class="modal-box" style="width:400px;text-align:center;">
            ...
            <div style="font-size:17px;font-weight:800;color:#111827;margin-bottom:8px;">Edit Request?</div>
            <div style="font-size:13px;color:#6b7280;margin-bottom:24px;">You are about to edit your request. Changes will reset approval status.</div>
            <div style="display:flex;justify-content:center;gap:12px;">
                <button class="btn-cancel" style="min-width:100px;" @click="showApprove=false">Cancel</button>
                <button style="min-width:100px;padding:8px 20px;border-radius:8px;font-size:13px;font-weight:600;font-family:inherit;cursor:pointer;border:none;background:#3b82f6;color:#fff;" @click="showApprove=false">Confirm</button>
            </div>
        </div>
    </div>
    ...
    <div x-show="showReject" class="modal-overlay" x-cloak @click.self="showReject=false">
        <div class="modal-box" style="width:420px;text-align:center;">
            ...
            <div style="font-size:13px;color:#6b7280;margin-bottom:14px;">Are you sure you want to cancel your request? This action cannot be undone.</div>
            
            <div style="display:flex;justify-content:center;gap:12px;margin-top:16px;">
                <button class="btn-cancel" style="min-width:100px;" @click="showReject=false">Cancel</button>
                <button style="min-width:100px;padding:8px 20px;border-radius:8px;font-size:13px;font-weight:600;font-family:inherit;cursor:pointer;border:none;background:#dc2626;color:#fff;" @click="showReject=false">Yes, Cancel</button>
            </div>
        </div>
    </div>
