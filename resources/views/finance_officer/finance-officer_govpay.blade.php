...
<head>
    ...
    <title>Govt. Contributions — MEDISOURCE Finance Officer</title>
...
<body class="bg-gray-50" x-data="{ sidebarCollapsed: localStorage.getItem('sidebarCollapsed') === 'true' }"
    ...
    <div class="transition-all duration-300" :class="sidebarCollapsed ? 'ml-20' : 'ml-64'">
        <div class="p-8">
            <h1 class="text-2xl font-bold text-gray-800">Govt. Contributions</h1>
            <p class="text-gray-500 mt-1">Manage government contributions (SSS, PhilHealth, Pag-IBIG).</p>
        </div>
    </div>
