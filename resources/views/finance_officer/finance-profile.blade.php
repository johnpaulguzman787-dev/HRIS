...
<div x-data="{
    ...
    <div class="hidden lg:block">
        @include('finance_officer.finance_sidebar', ['activeMenu' => 'profile'])
    </div>
            ...
            <div class="px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs sm:text-sm text-blue-100 mt-0.5 hidden sm:block">View employee information</p>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-0">
                        ...
                        <div class="info-row flex items-center gap-3 py-3 sm:py-4 px-2 sm:border-t sm:border-t-gray-100 sm:pl-6">
                            ...
                            <div>
                                ...
                                <span class="inline-flex items-center gap-1 px-2 sm:px-3 py-0.5 rounded-full text-[10px] sm:text-xs font-bold bg-green-100 text-green-700">
