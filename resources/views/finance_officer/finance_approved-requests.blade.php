    ...
    <style>
        * { font-family: 'DM Sans', sans-serif; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            .stat-grid { grid-template-columns: repeat(2, 1fr) !important; gap: 10px !important; margin-bottom: 18px !important; }
            .stat-card { padding: 14px 14px !important; border-radius: 12px !important; }
            .stat-card div div:first-child { font-size: 11px !important; }
            .stat-card div div:first-child + div { font-size: 24px !important; }
        }
        ...
        @media(min-width:640px){ .modal-box { border-radius:18px; max-width:540px; padding:32px; max-height:90vh; } }
        ...
        @media(min-width:640px){ .modal-confirm-btn { width:auto; } }
...
<div class="main-content"
    ...
    <div class="page-content space-y-4">
        ...
        <div class="bg-white rounded-2xl border border-gray-200" style="box-shadow:0 2px 12px rgba(0,0,0,0.06);">
            ...
            {{-- Toolbar --}}
            <form method="GET" action="{{ route('finance_officer.requests.approved') }}" id="filterForm" class="toolbar-wrap">
...
<script>
function openViewModal(ref, filed, reqType, subDetail, duration, reason, rejReason, hrNotes, approver, approvedAt, status) {
    document.getElementById('mRef').textContent       = ref;
    document.getElementById('mSub').textContent       = reqType + ' · ' + subDetail;
    ...
    html += '</div><div>';
    html += '<div style="font-size:13px;font-weight:700;color:#111827;">Filed by You</div>';
