                ...
                <div class="space-y-4 lg:space-y-5">
                    ...
                    <div class="bg-white rounded-xl p-4 lg:p-6 card-anim" style="animation-delay:0.42s; border:1px solid #e5e7eb;">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <a href="{{ route('finance_officer.payroll') }}" class="action-btn px-4 py-3 border border-gray-200 rounded-lg text-sm text-gray-600 font-medium text-center block">View Payroll</a>
