...
<div x-data="{ open: false, targetId: null, cancelling: false }"
    ...
    <div x-show="open"
        ...
        <div class="flex gap-3 justify-end">
            ...
            <button @click="cancelling = true; fetch('/finance_officer/leave/'+targetId+'/cancel',{method:'POST',headers:{'X-CSRF-TOKEN':document.querySelector('meta[name=csrf-token]').content}}).then(r=>{cancelling=false;if(r.ok)location.reload();else alert('Failed to cancel.');open=false;})"
                    :disabled="cancelling"
