...
<div x-data="{
    ...
    <option value="rejected" {{ request('status')==='rejected' ? 'selected' : '' }}>Rejected</option>
        ...
        <div class="toolbar">
            <div class="cal-nav">
                <a href="{{ route('finance_officer.leave.management', ['tab' => 'leave-calendar', 'month' => $calPrev]) }}" class="cal-nav-btn">
                ...
                <a href="{{ route('finance_officer.leave.management', ['tab' => 'leave-calendar', 'month' => $calNext]) }}" class="cal-nav-btn">
                    Next
            ...
            <div class="toolbar-right">
                <form method="GET" action="{{ route('finance_officer.leave.management') }}" id="calFilterForm" style="display:contents;">
