...
<head>
    ...
    <style>
        * { font-family: 'DM Sans', sans-serif; box-sizing: border-box; }
        ...
        .modal-box { background:#fff; border-radius:0px; width:600px; max-width:95vw; padding:32px; position:relative; box-shadow:0 24px 64px rgba(0,0,0,0.18); }
    ...
    <div class="flex items-center justify-between px-8 py-4">
        ...
        <div class="p-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200" style="box-shadow:0 2px 12px rgba(0,0,0,0.06);">
                ...
                {{-- Toolbar --}}
                <form method="GET" action="{{ route('hr.requests.approved') }}" id="filterForm"
...
<div id="viewModal" style="display:none;" class="modal-overlay" onclick="if(event.target===this)closeViewModal()">
    <div class="modal-box" style="width:600px;max-width:95vw;border-radius:18px;">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
                ...
                <div id="mSubDetail" class="modal-field"></div>
            </div>
        </div>
        <div class="grid grid-cols-2 gap-4 mb-4">
            <div>
...
function openViewModal(ref, dept, name, filed, reqType, subDetail, duration, reason, rejReason, hrNotes, approver, approvedAt, status) {
    ...
    document.getElementById('mSubDetail').textContent = subDetail;
    document.getElementById('mReason').textContent    = reason;

    // parse from/to from duration string
