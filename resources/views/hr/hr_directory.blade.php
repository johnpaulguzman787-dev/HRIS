...
<div x-data="{
    ...
    async resendVerificationEmail() {
        ...
        try {
            const res = await fetch(`/hr/employees/${this.selectedEmployee.id}/resend-verification`, {
                method: 'POST',
                headers: {
                    'Accept': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name=csrf-token]').getAttribute('content')
                            ...
                            <div class="flex flex-col sm:flex-row gap-2">
                                ...
                                <div class="w-full sm:w-14">
                                    <input type="text" x-model="newEmployeeForm.mi" placeholder="MI" minlength="1" maxlength="2"
                                        ...
                                        class="w-full px-2 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-400 uppercase text-gray-700 placeholder-gray-400">
                                </div>
