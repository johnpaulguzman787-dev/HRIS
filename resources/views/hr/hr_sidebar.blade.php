...
<style>
    ...
    .avatar-ring  { box-shadow: 0 0 0 3px rgba(59,130,246,.25); transition: box-shadow 0.3s ease; }
    .avatar-ring:hover { box-shadow: 0 0 0 5px rgba(59,130,246,0.35); }
    .collapse-btn { transition: background .15s, transform .2s; }
    ...
    <nav class="p-3 space-y-0.5 flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <div>
            <button @click="(isMobile || !sidebarCollapsed) 
                        ...
                        : window.location='{{ route('hr.employees.directory') }}'"
                class="nav-item w-full flex items-center justify-between px-3 py-2.5 rounded-lg 
                    {{ in_array($currentRoute, $employeeRoutes) ? 'text-blue-600 bg-blue-50' : 'text-gray-600 hover:bg-gray-50' }}">
            ...
            <div x-show="employeesOpen && (isMobile || !sidebarCollapsed)"
                ...
                <a href="{{ route('hr.employees.directory') }}" 
                   class="submenu-item block px-3 py-2 text-sm rounded-lg 
                       {{ $currentRoute === 'hr.employees.directory' ? 'text-blue-600 font-semibold bg-blue-50' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">
                    Employee Directory
                </a>
                <a href="{{ route('hr.employees.profile') }}"   
                   class="submenu-item block px-3 py-2 text-sm rounded-lg 
                       {{ $currentRoute === 'hr.employees.profile' ? 'text-blue-600 font-semibold bg-blue-50' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50' }}">
                    Employee Profile
                </a>
            </div>
        </div>
        ...
        <div>
            <button @click="(isMobile || !sidebarCollapsed) 
                        ...
                        : window.location='{{ route('hr.attendance.reports') }}'"
                class="nav-item w-full flex items-center justify-between px-3 py-2.5 rounded-lg
        ...
        <div>
            <button @click="(isMobile || !sidebarCollapsed) 
                        ...
                        : window.location='{{ route('hr.payslips') }}'"
                class="nav-item w-full flex items-center justify-between px-3 py-2.5 rounded-lg 
        ...
        <div>
            <button @click="(isMobile || !sidebarCollapsed) 
                        ...
                        : window.location='{{ route('hr.requests.pending') }}'"
                class="nav-item w-full flex items-center justify-between px-3 py-2.5 rounded-lg 
        ...
        <div class="pt-3 mt-2 border-t border-gray-100">
            ...
            <a href="{{ route('hr.settings') }}"
               class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg {{ $currentRoute === 'hr.settings' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50' }} group">
            ...
            <a href="{{ route('logout') }}" 
               onclick="event.preventDefault(); document.getElementById('hr-logout-form').submit();"
