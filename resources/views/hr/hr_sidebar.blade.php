...
<aside 
    ...
    <nav class="p-3 space-y-0.5 flex-1 overflow-hidden">
        ...
        <!-- Employees -->
        <div>
            <button @click="sidebarCollapsed ? window.location='{{ route('hr.employees.directory') }}' : employeesOpen = !employeesOpen"
        ...
        <!-- Time & Attendance -->
        <div>
            <button @click="sidebarCollapsed ? window.location='{{ route('hr.attendance.reports') }}' : attendanceOpen = !attendanceOpen"
        ...
        <!-- Payroll -->
        <div>
            <button @click="sidebarCollapsed ? window.location='{{ route('hr.payslips') }}' : payrollOpen = !payrollOpen"
        ...
        <!-- Requests & Approval -->
        <div>
            <button @click="sidebarCollapsed ? window.location='{{ route('hr.requests.pending') }}' : requestsOpen = !requestsOpen"
                class="nav-item w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-gray-600 hover:bg-gray-50">
                <div class="flex items-center space-x-3">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="pt-3 mt-2 border-t border-gray-100">
            ...
            <a href="{{ route('hr.settings') }}" class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg {{ $currentRoute === 'hr.settings' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50' }} group">
            <a href="#" 
