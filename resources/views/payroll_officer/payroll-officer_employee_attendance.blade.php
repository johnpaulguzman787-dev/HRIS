@php
    ...
    $attendanceRoutes = ['hr.attendance.reports', 'payroll_officer.attendance.employee', 'hr.attendance.shift', 'hr.attendance.leave'];
...
<head>
    ...
    <style>
        * { font-family: 'DM Sans', sans-serif; }
        ...
        @media (max-width: 1023px) { .main-content-margin { margin-left: 0 !important; } }
...
<div class="main-content-margin"
    ...
    <div class="main-content-padding">
        ...
        <div class="breadcrumb">
            <a href="{{ route('payroll_officer.attendance.employee', ['view' => 'monthly', 'month' => $selectedMonth]) }}">
        ...
        <div class="table-card">
            <div class="table-toolbar">
                ...
                <div class="toolbar-right">
                    <form method="GET" action="{{ route('payroll_officer.attendance.employee') }}" id="detailForm" style="display:contents;">
        ...
        <div class="table-card">
            <div class="table-toolbar">
                <h2>Attendance Records</h2>
                <div class="toolbar-right">
                    <form method="GET" action="{{ route('payroll_officer.attendance.employee') }}" id="filterForm" style="display:contents">
                ...
                <table class="monthly-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('payroll_officer.attendance.employee', ['employee_id' => $rec->employee_id ?? '', 'view' => 'monthly', 'month' => request('month', now()->format('Y-m'))]) }}"
