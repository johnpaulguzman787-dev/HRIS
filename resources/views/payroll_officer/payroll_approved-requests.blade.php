    ...
    <style>
        * { font-family: 'DM Sans', sans-serif; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .stat-card div:first-child { font-size: 10px !important; }
            .stat-card .text-2xl { font-size: 24px !important; }
...
<div class="main-content"
    ...
    <div class="page-content space-y-4">
        ...
        <div class="bg-white rounded-2xl border border-gray-200" style="box-shadow:0 2px 12px rgba(0,0,0,0.06);">
            ...
            {{-- Toolbar --}}
            <form method="GET" action="{{ route('payroll_officer.requests.approved') }}" id="filterForm" class="toolbar-wrap">
