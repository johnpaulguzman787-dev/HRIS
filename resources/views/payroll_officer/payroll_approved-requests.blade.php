...
<body>
<div class="flex min-h-screen" x-data="approvedLogsPayroll()">
    ...
    <div class="flex items-center justify-between px-8 py-4">
        ...
        <div class="p-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200" style="box-shadow:0 2px 12px rgba(0,0,0,0.06);">
                ...
                {{-- Toolbar --}}
                <form method="GET" action="{{ route('payroll_officer.requests.approved') }}" id="filterForm"
