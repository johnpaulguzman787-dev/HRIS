    ...
    <div class="page-content" style="padding:24px 32px;">
        ...
        <div class="rcard">
            ...
            <div class="action-row">
                <button class="btn-cancel-req" @click="selId={{ $req->id }};selName='{{ addslashes(trim((auth()->user()->employee->fname ?? '').' '.(auth()->user()->employee->lname ?? ''))) }}';selCancelUrl='/payroll_officer/requests/{{ $req->id }}/cancel';showCancel=true">
