{{-- FILE NAME: supervisor/profile/index.blade.php (Supervisor Employee Profile - Mobile Responsive) --}}
...
<div x-data="{
    ...
    <div class="hidden lg:block">
        @include('supervisor.supervisor_sidebar', ['activeMenu' => 'profile'])
    </div>
...
@media (max-width: 1024px) {
    .lg\:ml-20, .lg\:ml-72 { margin-left: 0 !important; }
}
</style>
