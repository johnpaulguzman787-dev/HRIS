...
<body x-data="supervisorGovpayApp()" x-init="init()" class="flex h-screen overflow-hidden bg-gray-50">
        ...
        <header class="anim-fade bg-gradient-to-br from-blue-500 to-blue-700 sticky top-0 z-10 shadow-lg mt-3 mx-3 lg:mt-4 lg:mx-4 rounded-2xl">
            <div class="px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                <div class="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div>
                        <h1 class="text-xl sm:text-2xl font-bold text-white">My Contributions</h1>
                        <p class="text-xs sm:text-sm text-blue-100 mt-1">Government contributions and deductions</p>
                    </div>
                </div>
