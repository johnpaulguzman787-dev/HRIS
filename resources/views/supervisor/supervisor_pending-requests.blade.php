...
<head>
    ...
    <style>
        *{font-family:'DM Sans',sans-serif;box-sizing:border-box;}
        ...
        @media(min-width:640px){.stat-card{padding:20px 22px;}}
        ...
        @media(min-width:640px){.toolbar-title{font-size:18px;}}
        .toolbar-right{
            display:flex;
            flex-direction:column;
            gap:10px;
        ...
        @media(min-width:640px){.search-box{width:auto;}}
        .search-box input{
            border:none;
        ...
        @media(min-width:640px){.search-box input{width:150px;}}
        ...
        @media(min-width:640px){.fsel{font-size:13px;padding:8px 28px 8px 12px;}}
        ...
        @media(min-width:640px){.btn-primary{width:auto;padding:9px 20px;}}
        ...
        @media(min-width:640px){.rcard{margin-bottom:16px;}}
        .rcard-head{
            display:flex;
            flex-direction:column;
        ...
        @media(min-width:640px){.emp-name{font-size:15px;}}
        .emp-dept{font-size:11px;color:var(--muted);margin-top:1px;}
        @media(min-width:640px){.emp-dept{font-size:12px;}}
        .rcard-right{
            display:flex;
            align-items:center;
            gap:6px;
        ...
        @media(min-width:640px){.req-id{font-size:12px;}}
        .badge{
            padding:2px 8px;
            border-radius:20px;
            font-size:10px;
        ...
        @media(min-width:640px){.rcard-body{padding:16px 20px;}}
        .dgrid{
            display:grid;
            grid-template-columns:repeat(2,1fr);
            gap:10px;
        ...
        @media(min-width:640px){.dlabel{font-size:11px;margin-bottom:3px;}}
        .dval{font-size:12px;font-weight:700;color:#111827;}
        @media(min-width:640px){.dval{font-size:13px;}}
        ...
        @media(min-width:640px){.rlabel{font-size:12px;margin-bottom:3px;}}
        .rtext{font-size:12px;color:#374151;}
        @media(min-width:640px){.rtext{font-size:13px;}}
        ...
        @media(min-width:640px){.pcircle{width:30px;height:30px;font-size:13px;}}
        ...
        @media(min-width:640px){.pname{font-size:11px;}}
        .pstatus{
            font-size:8px;
            color:var(--muted);
            text-align:center;
        }
        @media(min-width:640px){.pstatus{font-size:10px;}}
        .pline{
            height:2px;
            width:30px;
            background:#16a34a;
        ...
        @media(min-width:640px){.pline{width:60px;margin-top:14px;}}
        ...
        @media(min-width:640px){.doc-upload{padding:24px 20px;}}
        ...
        @media(min-width:640px){.page-content{padding:24px 32px;}}
    </style>
</head>
...
<div x-data="{
        ...
        <div class="px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
            <div class="flex items-center gap-3 min-w-0 flex-1">
                ...
                <div>
                    ...
                    <p class="text-xs sm:text-sm text-blue-100 mt-1">Requests awaiting your approval</p>
                </div>
            </div>
    ...
    <div class="page-content">
        ...
        @php
            ...
            $rejectUrl = $req->type === 'adjustment'
                ? '/supervisor/requests/adjustment/' . $req->id . '/reject'
                : '/supervisor/requests/' . $req->id . '/reject?type=' . $req->type;
        @endphp
        <div class="rcard">
            ...
            <div class="rcard-body">
                ...
                <div class="prog-steps">
                    ...
                    <div class="pline"></div>
                    <div class="pstep"><div class="pcircle pc-active"><svg style="width:12px;height:12px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h.01M12 12h.01M19 12h.01"/></svg></div><div class="pname">Supervisor</div><div class="pstatus">Pending</div></div>
                    <div class="pline" style="background:#e5e7eb;"></div>
            ...
            <div class="action-row">
                ...
                <button class="btn-reject" @click="selId={{ $req->id }};selName='{{ addslashes($empName) }}';selRejectUrl='{{ $rejectUrl }}';selType='{{ $req->type }}';showReject=true">
        ...
        <div style="text-align:center;padding:40px 16px;">
            ...
            <div style="font-size:12px;color:#d1d5db;margin-top:4px;">Requests from your department will appear here when submitted.</div>
        </div>
        @endforelse
            ...
            <div x-show="reqType==='leave'" x-transition
                 x-data="{ leaveTypeId:'', startDate:'', endDate:'', reason:'', fileName:'', saving:false, errorMsg:'',
                     ...
                     async submit(){
                         ...
                         const fi=document.getElementById('supLeaveDocInput');
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <select class="finput" x-model="leaveTypeId">
            ...
            <div x-show="reqType==='overtime'" x-transition
                 x-data="{ otDate:'', otStart:'', otEnd:'', reason:'', fileName:'', saving:false, errorMsg:'',
                     ...
                     async submit(){
                         ...
                         form.append('reason',this.reason);
                         const fi=document.getElementById('supOtDocInput');
                         if(fi.files[0]) form.append('document',fi.files[0]);
                         form.append('_token',document.querySelector('meta[name=csrf-token]').content);
                         const res=await fetch('{{ route('supervisor.requests.overtime.file') }}',{method:'POST',body:form});
                         this.saving=false;
                         const data=await res.json();
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <label class="doc-upload">
                        ...
                        <div style="font-size:13px;font-weight:600;color:#374151;" x-text="fileName||'Choose a file to upload'"></div>
                        <div style="font-size:12px;color:#9ca3af;">PDF or DOCX, max 10MB</div>
                        <input id="supOtDocInput" type="file" accept=".pdf,.docx" style="display:none;" @change="handleFile($event)">
                    </label>
                </div>
                <div class="mactions">
                    <button class="btn-cancel" @click="$root.showFileReq=false;$root.reqType=''">Cancel</button>
            ...
            <div x-show="reqType==='shift'" x-transition
                 x-data="{ requestedShiftId:'', effectiveFrom:'', effectiveUntil:'', reason:'', fileName:'', saving:false, errorMsg:'',
                     ...
                     async submit(){
                         ...
                         form.append('reason',this.reason);
                         const fi=document.getElementById('supShiftDocInput');
                         if(fi.files[0]) form.append('document',fi.files[0]);
                         form.append('_token',document.querySelector('meta[name=csrf-token]').content);
                         const res=await fetch('{{ route('supervisor.requests.shift.file') }}',{method:'POST',body:form});
                         this.saving=false;
                         const data=await res.json();
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <select class="finput" x-model="requestedShiftId">
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <label class="doc-upload">
                        ...
                        <div style="font-size:13px;font-weight:600;color:#374151;" x-text="fileName||'Choose a file to upload'"></div>
                        <div style="font-size:12px;color:#9ca3af;">PDF or DOCX, max 10MB</div>
                        <input id="supShiftDocInput" type="file" accept=".pdf,.docx" style="display:none;" @change="handleFile($event)">
                    </label>
                </div>
                <div class="mactions">
                    <button class="btn-cancel" @click="$root.showFileReq=false;$root.reqType=''">Cancel</button>
            ...
            <div x-show="reqType==='adjustment'" x-transition
                 x-data="{ adjDate:'', adjIn:'', adjOut:'', reason:'', fileName:'', saving:false,
                     ...
                     async submit(){
                         ...
                         form.append('reason',this.reason);
                         const fi=document.getElementById('supAdjDocInput');
                         if(fi&&fi.files[0]) form.append('document',fi.files[0]);
                         form.append('_token',document.querySelector('meta[name=csrf-token]').content);
                         const res=await fetch('{{ route('supervisor.requests.adjustment.file') }}',{method:'POST',body:form});
                         this.saving=false;
                         const data=await res.json();
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <label class="doc-upload">
                        ...
                        <div style="font-size:13px;font-weight:600;color:#374151;" x-text="fileName||'Choose a file to upload'"></div>
                        <div style="font-size:12px;color:#9ca3af;">PDF or DOCX, max 10MB</div>
                        <input id="supAdjDocInput" type="file" accept=".pdf,.docx" style="display:none;" @change="handleFile($event)">
                    </label>
                </div>
                <div class="mactions">
                    <button class="btn-cancel" @click="$root.showFileReq=false;$root.reqType=''">Cancel</button>
