...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/payroll_officer/payroll/period/{id}',              [\App\Http\Controllers\PayrollOfficerPayrollController::class, 'viewPeriod'])->name('payroll_officer.payroll.period.view');
